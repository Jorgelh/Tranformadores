...
public class STATUS extends javax.swing.JInternalFrame {
    ...
    private void ListarTrabajos(){
        ArrayList<ProductosTaller> result = InsertarProductosTaller.ListarProductosPendientes(PN.getText(),depto);
     ...
     private void ListarTrabajosEjemplos(){
        ArrayList<ProductosTaller> result = InsertarProductosTaller.ListarProductosPendientesEjemplo(PN1.getText(),depto);
     ...
     private void ListarProductosTrabajos(){
        ArrayList<ProductosTaller> result = InsertarProductosTaller.ListarProductosTrabajo(idlote,depto);
     ...
     private void RecargarTablaProductos(ArrayList<ProductosTaller> list){
             ...
             PENDIENTES.setModel(new javax.swing.table.DefaultTableModel(
                datos,
                new String[]{
                " ","DESCRIPCION","CANTIDAD","ESTATUS","FECHA SOLICITUD","NOTA"      })
             {  
                 @Override
             public boolean isCellEditable(int row, int column){
                 return false;
             ...
             TableColumn columna5 = PENDIENTES.getColumn("FECHA SOLICITUD");
     ...
     private void ListarProductosTrabajosEjemplos(){
        ArrayList<ProductosTaller> result = InsertarProductosTaller.ListarProductosTrabajoEjemplo(idloteejemplo,depto);
     ...
     private void RecargarTablaProductoseje(ArrayList<ProductosTaller> list){
             ...
             columna4.setPreferredWidth(120);
             TableColumn columna5 = PENDIENTESEjemplo.getColumn("FECHA SOLICITUD");
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("ESTADO DE PEDIDOS A TALLER");
    ...
    ps= cnn.prepareStatement("update pedidos_trabajos set status = 4, estado = 2 where id_pedido ="+idpedido);
    ps.executeUpdate();
    cnn.close();
    ps.close();
