 ...
 * @author jluis
 */
public class SN extends javax.swing.JInternalFrame {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////   
      ...
      private void ListarTrabajosdeEnvio(){
        ArrayList<ClassEnv> result = BDEnvios.ListarEnviosSN(Integer.parseInt(NO.getText()));
        TablaEnvi(result);  
    }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
     ...
     public void buscarSN(){
     
     try {
            ClassEnv E = BDEnvios.BuscarSN(Integer.parseInt(String.valueOf(ENVIO.getModel().getValueAt(ENVIO.getSelectedRow(),0))));
            SN.setText(String.valueOf(E.getSN()));
        } catch (Exception e) {
 ...
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
    ...
    private void actualizarSN() {
        int idlote = (Integer.parseInt(String.valueOf(ENVIO.getModel().getValueAt(ENVIO.getSelectedRow(), 0))));
        if (SN.getText().compareTo("") != 0) {

            try {
                Connection cnn = BD.getConnection();
                PreparedStatement ps = null;
                ps = cnn.prepareStatement("update lotesenvios set SN = " + SN.getText() + "  where id_lote =" + idlote);
                ps.executeUpdate();
                cnn.close();
                ps.close();
