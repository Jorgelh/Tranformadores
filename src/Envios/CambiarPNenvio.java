 ...
 * @author jluis
 */
public class CambiarPNenvio extends javax.swing.JInternalFrame {
    /** Creates new form EditarEnvio */
    public CambiarPNenvio() {
        initComponents();
        ListarEnvios();
    }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
     ...
     try {
            ...
            NoEnvio.setText(String.valueOf(E.getDatecode()));}
 ...
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
    ...
    private void actualizarNoEnvio() {

        int idlote = (Integer.parseInt(String.valueOf(ENVIO.getModel().getValueAt(ENVIO.getSelectedRow(), 0))));

        if (NoEnvio.getText().compareTo("") != 0) {

            try {
                Connection cnn = BD.getConnection();
                PreparedStatement ps = null;
                ps = cnn.prepareStatement("update lotesenvios set no_envio = " + NoEnvio.getText() + " where id_lote =" + idlote);
                ps.executeUpdate();
                cnn.close();
                ps.close();
 ...
 /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    
    ...
    private void initComponents() {
        ...
        NoEnvio = new javax.swing.JTextField();
        ...
        setClosable(true);
        setTitle("CAMBIAR FECHA DE ENVIO");
        ...
        NoEnvio.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(FechaEnvio, javax.swing.GroupLayout.DEFAULT_SIZE, 139, Short.MAX_VALUE)
                        .addComponent(NoEnvio)))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel6)
                    .addComponent(NoEnvio, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void ENVIOMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ENVIOMouseClicked
       ...
       NoEnvio.setText((String.valueOf(envios.getModel().getValueAt(envios.getSelectedRow(), 0))));
       FechaEnvio.setText((String.valueOf(envios.getModel().getValueAt(envios.getSelectedRow(), 1))));
      //buscarEnvios();
    ...
    private javax.swing.JTextField NoEnvio;
