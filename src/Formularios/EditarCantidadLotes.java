 ...
 * @author jluis
 */
public class EditarCantidadLotes extends javax.swing.JInternalFrame {
     int estandar;
     int cantidadporlote;
     int n;
     int id;
    ...
    int n1 = 0;
    public EditarCantidadLotes(){//(int i) {
    ...
    private void ListarTrabajos(){
        ArrayList<ClassTrabajos> result = InsertTrabajosTransformadores.ListarTraIniciadosTrasEdit(PN1.getText(),JOB1.getText());
   ...
   /* public void ingresoTrabajoSinCantidad(){
    ...
    private void initComponents() {
        ...
        QTYPORLOTE.setBackground(new java.awt.Color(255, 255, 153));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarCantidadLotes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarCantidadLotes().setVisible(true);
            }
        });
    }
